...
top1_jsonl_path = save_finetuning_dset(
    sorted_test_preds,
    truth,
    "../../fine_tuning_data/2024-02-13_willet-pytorch-all.jsonl",
)
...
comp_preds = read_preds_from_dir(
    ...
    glob_pattern="ptOutputs_competition_*.txt",
)
...
with open(
    "/oak/stanford/projects/babelfish/magneto/willett/pytorch_finetuned_lisa_competition.txt",
    "w",
) as f:
